...
# position relative to the first name in the list, follow that link and repeat the
...
# the name for your testing and the other is the actual data you need to process for
# the assignment
...
# seconds to make it difficult for you to do the assignment without writing a Python
# program. But frankly with a little effort and patience you can overcome these
# attempts to make it a little harder to complete the assignment without writing a
# Python program. But that is not the point. The point is to write a clever Python
# program to solve the program.
